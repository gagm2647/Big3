...
public class CircularBuffer<T> : ICircularBuffer<T>, IEnumerable<T>
{
    ...
    public CircularBuffer (int capacity)
    {
        if (capacity < 0)
        {
            throw new System.ArgumentOutOfRangeException("capacity", "must be positve");
        }
    ...
    public T Dequeue()
    {
        if (Count == 0)
        {
            throw new System.InvalidOperationException("Queue exhausted");
        }
